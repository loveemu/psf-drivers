...
.DEFINE PARAM_SONG_TYPE = $c00001
	.db	$00
.DEFINE PARAM_SONG_SUB = $c00002
	.db	$6b
.DEFINE PARAM_SONG_SUB_LOAD = $c00003
	.db	$00
.DEFINE PARAM_SONG_PRELOAD = $c00004
	.db	$00
.DEFINE PARAM_SONG_PRELOAD_FRAMES = $c00005
	.dw	$00
...
loc_PlayBGM:
	...
	; additional load for sequence
	lda	PARAM_SONG_SUB_LOAD
	bmi	loc_MainLoop
	jsr	$4d77
